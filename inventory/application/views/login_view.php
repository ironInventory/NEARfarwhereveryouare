...
<body>
  ...
  <style type="text/css">
    body {
    background-image: url('assets/dist/img/psa_background1.jpg');
...
<div class="login-box" style="float: center; margin-center: 100px; margin-top: 100px; background-color:#fff; opacity: 0.8;">
  ...
  <div>
   ...
   <br>
      <div class="login-logo">
       <center><img src="assets/dist/img/psa_logo1.png" alt="User Image" style="width:200px;height:200px;"></center>
  </div>
   <center>
   <h4><strong>Cordilla Administrative Region</strong></h4>
   </center>
...
<br>
    ...
    <br>
    <center><a data-toggle="modal" data-target="#forgotpass" style="color:blue;">Forgot password</a></center><br>

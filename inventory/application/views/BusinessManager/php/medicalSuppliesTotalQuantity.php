...
if(isset($_POST['medTQEdit'])){
    ...
    $sqlinsert1="INSERT INTO reorderlevelupdate (date_time, description, supply_type, user, old_reorder, new_reorder) VALUES ('".$date."', 'The product  <b>".$textDesc."</b> has changed its reorder level from the Old Reorder Level of  <b>".$oldReorderLevel."</b>  to the New Reorder Level of  <b>".$newReorderLevel."</b>.', 'Medical', '".$user."', '".$oldReorderLevel1."', '".$newReorderLevel1."')  ";

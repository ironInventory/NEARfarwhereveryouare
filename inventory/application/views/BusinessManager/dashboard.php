...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo 'dashboard' ?>" class="logo">
      ...
      <span class="logo-mini"><img src="assets/dist/img/psa.png" style="width:40px;height:40px;"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="assets/dist/img/psa_logo.png" alt="User Image" style="width:200px;height:50px;"></span>
    </a>

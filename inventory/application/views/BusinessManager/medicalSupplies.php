...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo '../dashboard'; ?>" class="logo">
      ...
      <span class="logo-mini"><!-- <b style="color:yellow;"> -->
        <img src="../assets/dist/img/psa.png" alt="User Image" style="width:80%;height:80%; margin-top: 12%;"> <!-- </b> --></span>
      <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><img src="../assets/dist/img/psa_logo.png" alt="User Image" style="width:100%;height:100%;"></span>
    </a>
    ...
    <!---------------------------------------------------- SUPPLIES MENU -------------------------------------------------------------->
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active">
              <a href="<?php echo 'medicalSupplies' ?>"><i class="fa fa-briefcase"></i> Supplies
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
...
<!-- LOCKSCREEN MENU -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
          <i class="fa fa-medkit"></i> <b>Supplies</b>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-medkit"></i>Supplies</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box-body">
        <table id="example" class="table list" style="width:100%">
          <?php
            $conn =mysqli_connect("localhost","root","", "inventory") or die('Error connecting to MySQL server.');
            $sql = "SELECT * FROM supplies WHERE soft_deleted='N' ";
            $result = $conn->query($sql);    
          ?>
                ...
                <?php if ($result->num_rows > 0) {
                  while($row = $result->fetch_assoc()) { ?>
                    <tr>
                      ...
                      <td align="right"><?php echo $row["stock_code"]; ?></td>
...
.list td {
  list-style: none;
  border-stlye : 3px solid #8e8c8c;
  border-bottom: 2.5px dotted #8e8c8c;
...
<form name="form42" id="user_form" method="post" action="medicalsupplies/generated">
  ...
  <!-- /.content-wrapper -->
   <footer class="main-footer">
    ...
    <strong>Copyright &copy; INVENTORY MANAGEMENT SYSTEM </strong> All rights
    reserved.
  </footer>
...
// Date range filter
  ...
  maxDateFilter = "";
    ...
    function( settings, data, dataIndex ) {
        var minQty = parseInt( $('#min').val(), 10 );
        var maxQty = parseInt( $('#max').val(), 10 );
        var quantity = parseFloat( data[5] ) || 0; // use data for the QTY column

        if ( ( isNaN( minQty ) && isNaN( maxQty ) ) ||
             ( isNaN( minQty   ) && quantity <= maxQty ) ||
             ( minQty <= quantity && isNaN( maxQty ) ) ||
             ( minQty <= quantity && quantity <= maxQty ) )
        {
            return true;
        }
        return false;
